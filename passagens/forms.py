...
class PassagemForms(forms.ModelForm):
    data_pesquisa = forms.DateField(label='Daata da pesquisa' , disabled=True,initial=datetime.today)
    class Meta:
        model = Passagem
        fields ='__all__'
        labels = { 'data_ida': 'Data de Ida', 'data_volta': 'Data de Volta', 'classe_viagem': 'Classe de Viagem', 'informacoes' : 'Informações', 'data_pesquisa': 'Data da Pesquisa' }
        widgets = {
            'data_ida': DatePicker(),
